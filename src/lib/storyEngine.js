 ...
 * @param {{ narration: string, genre: string, heroName: string, lastChoice?: string, sceneNumber?: number, establishedIllustrationCast?: Record<string, string>, signal?: AbortSignal }} params
