...
- **AI story scenes** — Each beat is generated with **Claude** (Anthropic) using structured JSON so narration, choices, and cast data stay consistent. Stories honor prior choices and continuity across up to **six** scenes.
